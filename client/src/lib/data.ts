...
export interface BlogPost extends PostVersion {
  slug: string;
  date: string;
  ...
  lang: PostLang;
  image?: string;
  translations?: Partial<Record<PostLang, PostVersion>>;
  featured?: boolean;
  tags?: string[];
}
...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: stupidityContentEn,
    readingTime: calculateReadingTime(stupidityContentEn),
    featured: true,
    translations: {
      pt: {
