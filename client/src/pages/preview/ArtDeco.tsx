...
:root {
  ...
  --accent: #d4a574; --accent-light: #e8c9a0; --accent-dark: #c9a961;
  ...
  --gradient-gold: linear-gradient(135deg, var(--accent-dark) 0%, var(--accent) 25%, var(--accent-light) 50%, var(--accent) 75%, var(--accent-dark) 100%);
...
.display-subtitle { font-family: var(--font-heading); font-size: clamp(1rem, 2vw, 1.5rem); letter-spacing: 0.5em; text-transform: uppercase; color: var(--accent); font-weight: 300; }
...
.heading-2 { font-family: var(--font-heading); font-size: clamp(1.5rem, 3vw, 2rem); letter-spacing: 0.15em; text-transform: uppercase; color: var(--accent-light); font-weight: 500; }
.body-text { font-family: var(--font-body); font-size: 1rem; line-height: 1.8; color: var(--pearl); font-weight: 300; }
.mono-text { font-family: var(--font-mono); font-size: 0.875rem; color: var(--accent); }

.btn-deco { display: inline-flex; align-items: center; justify-content: center; padding: 1rem 2.5rem; font-family: var(--font-heading); font-size: 0.875rem; font-weight: 500; letter-spacing: 0.2em; text-transform: uppercase; text-decoration: none; color: var(--accent); background: transparent; border: 2px solid var(--accent); position: relative; overflow: hidden; cursor: pointer; transition: all var(--transition-base); }
.btn-deco:hover { color: var(--navy); background: var(--accent); box-shadow: var(--shadow-glow); }
...
.card-deco:hover { border-color: var(--accent); box-shadow: var(--shadow-glow); transform: translateY(-4px); }
